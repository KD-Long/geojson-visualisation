...
var showHoverTooltipHost = showTooltip.compute([showHoverTooltip], (state) => {
  ...
  return {
    ...
    end: Math.max(...tooltips2.filter((t2) => t2.end != null).map((t2) => t2.end)),
...
function repositionTooltips(view) {
  var _a2;
  (_a2 = view.plugin(tooltipPlugin)) === null || _a2 === void 0 ? void 0 : _a2.maybeMeasure();
}
...
//# sourceMappingURL=chunk-ZQN4DN5R.js.map
